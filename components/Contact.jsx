      ...
      <div className="content">
        ...
        >
          <div className="flex flex-col relative group">
            ...
            <label className="animated" htmlFor="firstName">
              First Name
            </label>
          </div>
          <div className="flex flex-col relative group">
            ...
            <label htmlFor="lastName" className="animated">
              Last Name
            </label>
          </div>
          <div className="flex flex-col relative group">
          ...
          <div className="flex flex-col relative group">
            ...
            <label htmlFor="phone" className="animated">
              Phone
            </label>
          </div>
          <div className="flex flex-col relative group">
            ...
            <select
              id="name"
              className="py-1 w-full outline-none mb-3 text-xl text-slate-200 bg-transparent border-b border-b-white"
          ...
          <div className="flex flex-col relative group">
            <textarea
              ...
              id="message"
              required
              className="mb-3 w-full text-xl peer bg-transparent outline-none border-b border-b-white"
              {...register("message", { required: true })}
            />
            {errors.message && <span>This field is required</span>}
            <label htmlFor="message" className="animated">
              Message
            </label>
          </div>
          <input
